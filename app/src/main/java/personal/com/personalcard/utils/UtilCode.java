...
public class UtilCode {
    ...
    public static void function(Activity activity) {
        ...
        LogUtils.iTag(TAG, mainActivity);
        ...
        for (Activity a : activityList) {
            LogUtils.iTag(TAG, a.getLocalClassName());
        }
        ...
        LogUtils.iTag(TAG, appInstalled);
        /**
         * 卸载 App  可以成功卸载
         */
//        AppUtils.uninstallApp("com.qudong.test");
        ...
        LogUtils.iTag(TAG,appSignatureSHA1);
        /**
         * 获取app的信息
         */
        final AppUtils.AppInfo appInfo = AppUtils.getAppInfo();
        LogUtils.i(TAG,appInfo.getPackagePath());
